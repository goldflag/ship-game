# Custom battle performance (archived log)

Archived 2026-09-19 from docs/custom-battle-performance.md; historical record, not current guidance; dated
measurements and experiments, some predating the retirement of `src/simulation` TypeScript stepping on 2026-09-16.
