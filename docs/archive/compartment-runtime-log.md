# Combat runtime profile experiments: measurement log

Archived 2026-09-19 from `docs/compartment-runtime.md`. Historical record of the September 16, 2026
Hipper measurements, not current guidance; the Hipper construction conversion it measured was removed.
Text below is verbatim apart from relative links.
