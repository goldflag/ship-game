# Simulation performance plan (archived log)

Archived 2026-09-19 from docs/sim-performance-plan.md; historical record, not current guidance; claims about
`src/simulation` TypeScript stepping (the "TypeScript mirror" and "twin") predate its retirement on 2026-09-16.
