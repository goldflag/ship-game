...
Required for ship geometry and articulation work when MCP is available. Documentation-only, simulation-only and unchanged-asset checks do not require an interactive Blender session.
