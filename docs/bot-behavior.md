...
Nearest-opponent selection retains its 25% hysteresis and includes damaged or disarmed ships while they remain physically afloat. Weapon or ammunition loss does not retire a hull from movement, targeting or tonnage scoring in legacy battles. Legacy Custom/online autonomous captains retain this compatibility behavior. PvE captains use their team’s permitted observation tracks and the coordinated commander described below.
