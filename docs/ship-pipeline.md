...
Combat knockout uses the authored main battery and torpedo tubes; surviving secondary guns do not extend a battleship's fighting strength. Ships with neither main guns nor tubes use their secondary mounts. A weapon needs enough AP or HE rounds for a complete mount salvo and a surviving magazine to be recoverable. Temporary immersion remains recoverable; permanent primary loss latches `knocked-out` until reset. Knocked-out actors cease fire and receive neutral helm orders, retain collisions and damage control, and can sink later. The equipment meter and damage scoring remain independent of knockout, so a ship can leave battle with equipment HP remaining. This is gameplay tuning, not a historical surrender model.
