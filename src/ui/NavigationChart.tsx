...
export function NavigationChart({ data, reports = [], onResize, bindings }: { reports?: readonly ContactTrack[]; data: Telemetry; bindings: Keybindings; onResize(direction: number): void }) {
  const clipId = useId();
