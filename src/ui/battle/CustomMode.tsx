...
import { botSelection, MAX_BATTLE_SPAWN_DISTANCE, MAX_TEAM_SHIPS, MIN_BATTLE_SPAWN_DISTANCE, type BattleSetup, type SpawnFormation } from '../../game/session/battleSetup';
