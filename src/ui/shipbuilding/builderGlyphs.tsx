...
const TOOL_PATHS: Record<string, string> = {
  ...
  Hull: 'M2 8h16l-3 6H5zM10 8V4M7 8V6',
  Machinery: 'M8.5 10a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0M10 8.5C8.2 6.5 8.4 3.4 10 2.5c1.8.9 1.9 4 0 6M11.3 10.8c2.6-.6 5.3.8 5.5 2.7-1.6 1.1-4.4-.1-5.5-2.7M8.7 10.8c-2.6-.6-5.3.8-5.5 2.7 1.6 1.1 4.4-.1 5.5-2.7',
  Outfit: 'M8.5 3.5a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0M10 5v12M6.5 8h7M3.5 12c.5 3 3.2 5 6.5 5s6-2 6.5-5M3.5 12l-1.2 1.6M16.5 12l1.2 1.6', Armor: 'M10 2l7 3v5c0 4-3 7-7 8-4-1-7-4-7-8V5z',
