...
- **View bar** (lower right). View (cycles Orbit, Plan, Profile, Bow), Slice, Centers, snap step, Mirror and Fit. Centers toggles the gold center-of-gravity (mass) and mint center-of-buoyancy dots together, initially on; the choice lasts while the editor stays open. The bar prints no keycaps; the keys live in the Keys dialog and the table below.
