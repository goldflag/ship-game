...
export type FittingCategory = 'main-battery' | 'light-aa' | 'torpedoes' | 'fire-control' | 'superstructure' | 'running-gear' | 'deck-gear' | 'boats-aviation';
...
const NATION_PREFIXES: [RegExp, FittingNation][] = [
  [/^(us|fletcher|iowa)-/, 'United States'], [/^(german|sk-?c\d|flak)/, 'Germany'], [/^(ijn|type\d)/, 'Japan'], [/^(rn|uk|british)-/, 'United Kingdom'],
];
