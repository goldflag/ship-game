...
export type BuilderRevisionDoor = Pick<
  ConstructionRevisionOwner,
  'source' | 'refusal' | 'locked' | 'submit' | 'undo' | 'redo' | 'setError' | 'setBusy' | 'subscribe'
>;
...
export const BUILDER_DISPLAY: Record<BuilderLayer, BuilderDisplay> = {
  hull: 'paint',
  armor: 'armor',
  internals: 'internals',
  fittings: 'paint',
...
export const SNAP_STEPS = [0.25, 0.5, 1, 2, 5];
