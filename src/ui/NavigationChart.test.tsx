...
test('the helm minimap renders permitted report estimates and uncertainty without a hidden actor', () => {
  ...
  expect(report.estimatedPosition).toEqual([800, 0, -400]);
