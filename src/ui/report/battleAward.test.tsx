...
test('XP counts toward the next ship in the line sailed, or the cheapest open one, and nothing when every ship is owned', () => {
  ...
  // A design outside the tree counts toward the cheapest open ship: Omaha (1,500 XP) at the head of the cruiser line.
  expect(unlockProgress(profile, award, 'local-design')?.name).toBe('Omaha');
