...
export class Game {
  ...
  private get graphicsControl(): GraphicsController {
    ...
    return this.graphicsController ??= new GraphicsController({
      ...
      get renderer() { return game.renderer; }, get finalFrame() { return game.finalFrame; }, get scenePass() { return game.scenePass; }, get camera() { return game.camera; }, get water() { return game.water; }, get sunLight() { return game.sunLight; }, get sky() { return game.sky; },
