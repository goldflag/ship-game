...
export class CombatEffects {
  ...
  constructor() {
    ...
    for (const mesh of [this.projectiles, this.streaks, this.torpedoBodies, this.torpedoWakes, this.depthChargeBodies]) {
  ...
  dispose(): void {
    ...
    for (const mesh of [this.projectiles, this.streaks, this.torpedoBodies, this.torpedoWakes, this.depthChargeBodies]) { mesh.dispose(); mesh.geometry.dispose(); mesh.material.dispose(); }
