...
export const SKY_TIERS: Readonly<Record<SkyQuality, SkyTier>> = {
  ...
  high: { cloudScale: 2, cloudInterleave: 2, cloudSteps: 96, cloudLightSteps: 6, cloudShadowSize: 512, environmentWidth: 512, environmentSteps: 24, shaftSamples: 32, rainDrops: 12000, stars: 9000 },
  ultra: { cloudScale: 2, cloudInterleave: 2, cloudSteps: 128, cloudLightSteps: 6, cloudShadowSize: 512, environmentWidth: 768, environmentSteps: 32, shaftSamples: 48, rainDrops: 20000, stars: 9000 },
};
