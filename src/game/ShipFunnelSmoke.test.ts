...
test('all registered funnel mouths are found without smoking from bases, caps or the submarine', () => {
  const counts: Record<string, number> = { 'admiral-hipper': 1, kongo: 2, bismarck: 1, yamato: 1, iowa: 2, 'king-george-v': 2, baltimore: 2, mogami: 2, 'enterprise-cv6': 1, 'type-viic': 0,
