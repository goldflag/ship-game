...
Overhead labels identify battle ships by preset name and You, Ally N or Enemy N, with live structural HP out of 1,000 and a meter. They follow the displayed hull poses, make room for the instruments and aiming sight, and hide outside the camera view, when no clear placement fits, with the HUD or in port. Sinking labels retain the remaining structural HP, since flooding can sink a ship before its structure reaches zero.
