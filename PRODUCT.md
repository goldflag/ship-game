...
Start in the Fleet harbor garage. Custom battle replaces Set sail and the sea trial: choose the player's ship, zero to four friendly bots and one to five enemy bots. Bismarck, Yamato, Baltimore and Enterprise can occupy any slot, including duplicates. Spawn distance selects 1–20 km between formation lines in 0.5 km steps, defaulting to 5 km. Start battle deploys both teams facing each other, with 650 m between adjacent ships. Return to port resets every ship, ammunition, shells and flooding. Fleet selections and spawn distance are retained during the page session. Currency, commander skills, research, daily orders and refits remain authorized mock content, clearly labeled as progression previews and kept in memory.
