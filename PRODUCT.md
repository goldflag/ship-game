...
Overhead labels on friendly and enemy bots show the ship name, live hull-HP bar, percentage and vessel status without a background box or visible team/slot text. The player's own ship has no overhead label. Mint and salmon bars distinguish friendly and enemy ships. Labels follow the displayed hull poses directly and may overlap each other or the HUD. They hide outside the camera view, with the HUD or in port. Hull exhaustion starts sinking; buoyancy and stability can also sink a ship with HP remaining. Gunnery shows equipment condition separately. A Bismarck survives eight landed 38 cm AP shells; four fully landed waterline broadsides exhaust its hull, with dispersion extending the exchange. Hull HP is a gameplay balance value.
