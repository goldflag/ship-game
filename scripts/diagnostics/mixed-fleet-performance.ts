...
console.log(JSON.stringify({ ships: sim.actors.length, ticks, seconds: sim.tick / 60,
  ...
  fullStateHash: Bun.hash(JSON.stringify({ actors: sim.actors, shells: sim.shells, torpedoes: sim.torpedoes, depthCharges: sim.depthCharges, aircraft: sim.aircraft, events: sim.events })).toString(),
}, null, 2));
