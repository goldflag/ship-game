"""__SHIP_NAME__ recipe: a Blender-recipe preset scaffolded by `ship:new --legacy`.
...
scene.world = bpy.data.worlds.new('__SHIP_NAME__ review world')
...
for key, color in colors.items():
    m = bpy.data.materials.new('__SHIP_NAME__ ' + key)
...
print('__SHIP_NAME__ recipe:', len(scene.objects), 'objects; source saved')
