...
const producerFiles = ['src/game/constructionModel.ts', 'src/game/constructionFittingPaint.ts', 'src/game/constructionPropellerModel.ts', 'src/game/constructionShading.ts', 'src/ships/constructionEquipment.ts', 'src/ships/constructionPaints.ts', 'src/ships/constructionHullPaint.ts', 'src/game/loadShipModel.ts', 'tools/construction/review.ts', 'scripts/construction/pipeline.ts', 'assets/ships/appearance/finishes.json', 'crates/naval-wasm/src/lib.rs', 'crates/naval-sim/src/catalog.rs', 'crates/naval-sim/src/mount_clearance.rs'];
