...
const recipeFiles = ['src/ships/componentMaterials.ts', 'assets/parts/materials.json', 'assets/ships/appearance/finishes.json', 'src/ui/shipbuilding/slotImages.ts', 'src/game/loadShipModel.ts',
  'src/game/constructionTubeGeometry.ts', 'src/game/constructionVentModel.ts', 'assets/parts/construction/vent_geometry.ts', 'src/game/constructionPathModel.ts', 'src/ships/constructionPaths.ts', 'assets/parts/construction/path_geometry.ts', 'assets/parts/construction/ladder_geometry.ts', 'src/ships/constructionLadders.ts', 'assets/parts/construction/access_geometry.ts', 'src/game/constructionAccessModel.ts'];
