...
- `bun test`: **107 passed, 0 failed**. Audio coverage includes event routing/deduplication, resets, spatial mixing, obsolete saved-setting fields, source/output hashes and absence of excluded runtime files. Existing simulation tests also pass.
