...
EC2-S-C1 Liberty, 1943–44 representative limited-capacity troop transport fit

Archived preset; its old URL selects `victory-cargo`. Preserved exports are in `retired-public/`.
...
```sh
bun run ship:compile liberty-troopship
bun run ship:build liberty-troopship
bun run ship:review liberty-troopship
bun run ship:check liberty-troopship
```
