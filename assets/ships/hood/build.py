...
bulwark('Lower bridge after screen', rt(across([(2.83, -28.45), (2.8, -27.72), (1.8, -27.7), (1.8, -27.2), (2.05, -26.9), (0, -26.9)])), 14.15, 15.2)
rail('Admiral bridge after rail', [(x, y, 16.55) for x, y in rt(across([(2.8, -29.6), (2.8, -28.4), (2.38, -26.85), (0, -26.85)]))], 1.0, 1.6)
prism('Bridge trunk', [(28.55, 1.0), (29.5, 1.0), (29.5, -1.0), (28.55, -1.0)], 12.0, 2.0, 'naval')
