"""Shared vocabulary for the Ise recipe and its region modules (adapted from the Kongō kit).

Positions in the region modules are reference-frame datums read off the approved
GameModels3D pjsb526 A hull (x starboard, y up, z toward the stern, metres), converted
