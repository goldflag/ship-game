...
Open `/?ship=omaha` or select this ship in port or Custom battle once it is registered.
...
```sh
python3 assets/ships/omaha/author-blueprint.py
bun run ship:build omaha
bun run ship:review omaha
bun run ship:check omaha
```
