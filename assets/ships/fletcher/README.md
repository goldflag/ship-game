...
- **Shared parts:** the Mk 30 (`us-5in38-mk30-single`) gunhouse matches the reference's length and profile (box IoU .82 side, .92 front at our 0.25 m seat) but lacks its full-height rear skirt; the twin Bofors (open mount, shorter pedestal) and Oerlikon differ in detail. These are shared parts and are not edited here.
