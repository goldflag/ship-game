...
- The main battery uses the registered original 46 cm triple builder, including its articulated canvas and refined gunhouse. Its fixed lower barbettes retain the existing installed yaw datums; taller closed gun ports preserve the full catalog elevation range and remain an explicit reference approximation. Internal layouts, armor thicknesses, loading, flooding and ballistics remain provisional gameplay models.
