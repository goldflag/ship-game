"""Integration evidence: compare origin/master 89fd9850 scenes with the rebuilt sources.
...
for ship, before_dir, report_dir in [
    ('bismarck', 'pr-integration-bismarck-master', 'paint-crest-integration'),
    ('yamato', 'pr-integration-yamato-master', 'paint-crest-integration'),
]:
