...
balcony outline**. New platforms are in **Hull → All shapes → Balcony**. The
source stays in the shared versioned blueprint format; this test ship is not in
the runtime preset roster.
