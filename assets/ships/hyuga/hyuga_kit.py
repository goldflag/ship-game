"""Shared vocabulary for the Hyūga recipe's region modules (after the Kongō kit).

Positions in the region modules are reference-frame datums read off the approved
GameModels3D pjsb517 A hull (x starboard, y up, z toward the stern, metres), converted
