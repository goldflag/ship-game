...
Aim AP at turrets or magazines to disable weapons. AP applies 75% of its listed damage on a direct equipment strike, up from 25%, with a separate protected burst after its fuze delay. **Surviving guns keep fighting**, including secondaries after the main battery is destroyed. Main-battery loss adds no special ship status. Disabled turrets stop traversing and elevating at their last simulation angle; they still move with the hull. Temporary magazine flooding can recover when drained. A ship leaves the battle only when sunk or permanently unable to use any gun or torpedo; loss of propulsion alone does not silence its weapons. Armor still protects machinery, and flooding and stability determine sinking. See the [damage and turret behavior update](assets/reviews/damage-realism/disabled-turrets.md).
