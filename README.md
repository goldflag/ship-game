...
Friendly and enemy bots have an overhead name, live equipment-condition bar and vessel status, floating directly above their ships without a background box, connector or team text. Your own ship has no overhead label. Mint bars identify friendly ships and salmon bars identify enemies. Labels stay at their projected ship positions and may overlap each other or the instruments. They follow the displayed hull poses, hide outside the camera view, and follow the H instrument toggle. The percentage summarizes surviving equipment; it does not decide whether the hull floats.
